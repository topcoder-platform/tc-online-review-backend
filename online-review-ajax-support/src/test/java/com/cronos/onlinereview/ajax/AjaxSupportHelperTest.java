...
//    }
    ...
    public void testCreateAndLogSucceess() {
        AjaxResponse response = AjaxSupportHelper.createAndLogSuccess("test", "success", "a test", null, null);
        assertEquals("The type is not right.", "test", response.getType());
        assertEquals("The status is not right.", "success", response.getStatus());
    }
    ...
    public void testcreateAndLogSucceessNullType() throws Exception {
        try {
            AjaxSupportHelper.createAndLogSuccess(null, "success", "a test", null, null);
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException e) {
            // should land here
        }
    ...
    public void testcreateAndLogSucceessEmptyType() throws Exception {
        try {
            AjaxSupportHelper.createAndLogSuccess(" ", "success", "a test", null, null);
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException e) {
            // should land here
        }
    ...
    public void testcreateAndLogSucceessNullStatus() throws Exception {
        try {
            AjaxSupportHelper.createAndLogSuccess("test", null, "a test", response, null);
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException e) {
            // should land here
        }
    ...
    public void testcreateAndLogSucceessStatus() throws Exception {
        try {
            AjaxSupportHelper.createAndLogSuccess("test", " ", "a test", response, null);
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException e) {
            // should land here
        }
