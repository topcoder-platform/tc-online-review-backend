 ...
 * 
 */
public abstract class APIApplication<T extends APIBaseConfiguration> extends Application<T> {
	...
	public abstract List<String> getValidIssuers();
	...
	protected void configureAuth(T configuration, Environment environment) {
		JWTAuthenticator authenticator = new JWTAuthenticator(configuration.getAuthDomain(), getSecret(),getValidIssuers());
