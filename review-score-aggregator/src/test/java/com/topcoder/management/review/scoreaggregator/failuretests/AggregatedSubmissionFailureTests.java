...
public class AggregatedSubmissionFailureTests extends TestCase {
    ...
    public void testAggregatedSubmissionNegativeId() {
        try {
            new AggregatedSubmission(-1L, new double[] {90.5f, 88.5f, 95.5f}, 94.0f);
    ...
    public void testAggregatedSubmissionZeroId() {
        try {
            new AggregatedSubmission(0L, new double[] {90.5f, 88.5f, 95.5f}, 94.0f);
            fail("IllegalArgumentException should be thrown.");
        } catch (IllegalArgumentException e) {
            // expected
        }
    ...
    public void testAggregatedSubmissionNegativeScores() {
        try {
            new AggregatedSubmission(1L, new double[] {90.5f, -1.5f, 95.5f}, 94.0f);
            fail("IllegalArgumentException should be thrown.");
        } catch (IllegalArgumentException e) {
            // expected
        }
    ...
    public void testAggregatedSubmissionZeroScores() {
        new AggregatedSubmission(1L, new double[] {90.5f, 0.0f, 95.5f}, 94.0f);
    }
    ...
    public void testSubmissionNaNScores() {
        try {
            new AggregatedSubmission(1L, new double[] {90.5f, Float.NaN, 95.5f}, 94.0f);
            fail("IllegalArgumentException should be thrown.");
        } catch (IllegalArgumentException e) {
            // expected
        }
    ...
    public void testAggregatedSubmissionPositiveInfScores() {
        try {
            new AggregatedSubmission(1L, new double[] {90.5f, Float.POSITIVE_INFINITY, 95.5f}, 94.0f);
            fail("IllegalArgumentException should be thrown.");
        } catch (IllegalArgumentException e) {
            // expected
        }
    ...
    public void testAggregatedSubmissionNegativeInfScores() {
        try {
            new AggregatedSubmission(1L, new double[] {90.5f, Float.NEGATIVE_INFINITY, 95.5f}, 94.0f);
            fail("IllegalArgumentException should be thrown.");
        } catch (IllegalArgumentException e) {
            // expected
        }
    ...
    public void testAggregatedSubmissionNegativeAgg() {
        try {
            new AggregatedSubmission(1L, new double[] {90.5f, 94.0f, 95.5f}, -1.0f);
            fail("IllegalArgumentException should be thrown.");
        } catch (IllegalArgumentException e) {
            // expected
        }
    ...
    public void testAggregatedSubmissionZeroAgg() {
        new AggregatedSubmission(1L, new double[] {90.5f, 94.0f, 95.5f}, .0f);
    }
    ...
    public void testAggregatedSubmissionNegativeInfAgg() {
        try {
            new AggregatedSubmission(1L, new double[] {90.5f, 94.0f, 95.5f}, Float.NEGATIVE_INFINITY);
            fail("IllegalArgumentException should be thrown.");
        } catch (IllegalArgumentException e) {
            // expected
        }
    ...
    public void testAggregatedSubmissionPositiveInfAgg() {
        try {
            new AggregatedSubmission(1L, new double[] {90.5f, 94.0f, 95.5f}, Float.POSITIVE_INFINITY);
            fail("IllegalArgumentException should be thrown.");
        } catch (IllegalArgumentException e) {
            // expected
        }
    ...
    public void testAggregatedSubmissionNaNAgg() {
        try {
            new AggregatedSubmission(1L, new double[] {90.5f, 94.0f, 95.5f}, Float.NaN);
            fail("IllegalArgumentException should be thrown.");
        } catch (IllegalArgumentException e) {
            // expected
        }
    ...
    public void testAggregatedSubmissionSubmissionFloatNegativeAgg() {
        try {
            new AggregatedSubmission(new Submission(1L, new double[] {94.0f}), -1.0f);
            fail("IllegalArgumentException should be thrown.");
        } catch (IllegalArgumentException e) {
            // expected
        }
    ...
    public void testAggregatedSubmissionSubmissionFloatZeroAgg() {
        new AggregatedSubmission(new Submission(1L, new double[] {94.0f}), .0f);
    }
    ...
    public void testCompareToNonAggregatedSubmission() {
        try {
            new AggregatedSubmission(new Submission(1L, new double[] {94.0f}), 94.0f).compareTo(new Object());
