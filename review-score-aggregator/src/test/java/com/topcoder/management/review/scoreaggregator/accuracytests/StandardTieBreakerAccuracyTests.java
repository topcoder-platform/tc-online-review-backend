...
public class StandardTieBreakerAccuracyTests extends TestCase {
    ...
    public void testBreakTies1() throws Exception {
        ...
        for (int i = 0; i < 3; i++) {
            double[] scores = new double[] {i, i + 1, i + 2};
    ...
    public void testBreakTies2() throws Exception {
         ...
         */
        submissions[0] = new AggregatedSubmission(1, new double[] {80.125f, 80.125f, 80.125f},
                80.125f);
        submissions[1] = new AggregatedSubmission(2, new double[] {81.125f, 81.125f, 78.125f},
                80.125f);
        submissions[2] = new AggregatedSubmission(3, new double[] {82.125f, 82.125f, 76.125f},
                80.125f);
    ...
    public void testBreakTies3() throws Exception {
         ...
         */
        for (int i = 0; i < 3; i++) {
            double[] scores = new double[] {80.125f, 80.125f, 80.125f};
    ...
    public void testBreakTies4() throws Exception {
        ...
        submissions[0] = new AggregatedSubmission(1, new double[] {80.125f, 80.125f, 80.125f},
                80.125f);
        submissions[1] = new AggregatedSubmission(2, new double[] {78.125f, 81.125f, 81.125f},
                80.125f);
        submissions[2] = new AggregatedSubmission(3, new double[] {78.125f, 81.125f, 81.125f},
                80.125f);
