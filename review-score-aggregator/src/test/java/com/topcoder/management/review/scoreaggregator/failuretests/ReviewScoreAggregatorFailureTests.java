...
public class ReviewScoreAggregatorFailureTests extends TestCase {
    ...
    public void testAggregateScoresFloatArrayArrayNullScoresArray()
        throws Exception {
        try {
            this.aggregator.aggregateScores((double[][]) null);
            fail("IllegalArgumentException should be thrown.");
        } catch (IllegalArgumentException e) {
            // expected
        }
    ...
    public void testAggregateScoresFloatArrayArrayNullScoresEntries()
        throws Exception {
        try {
            this.aggregator.aggregateScores(new double[][] {new double[] {95.0f}, null});
            fail("IllegalArgumentException should be thrown.");
        } catch (IllegalArgumentException e) {
            // expected
        }
    ...
    public void testAggregateScoresFloatArrayArrayNegativeScoresEntries()
        throws Exception {
        try {
            this.aggregator.aggregateScores(new double[][] {new double[] {95.0f}, new double[] {-0.5f}});
            fail("IllegalArgumentException should be thrown.");
        } catch (IllegalArgumentException e) {
            // expected
        }
    ...
    public void testAggregateScoresFloatArrayArrayInconsistentScoresEntries() {
        try {
            this.aggregator.aggregateScores(new double[][] {new double[] {95.0f}, new double[] {95.5f, 90.9f}});
    ...
    public void testAggregateScoresSubmissionArrayInconsistentEntries() {
        try {
            this.aggregator.aggregateScores(new Submission[] {
                new Submission(1L, new double[] {95.5f}), new Submission(2L, new double[] {95.5f, 98.5f})
            });
            fail("InconsistentDataException should be thrown.");
        } catch (InconsistentDataException e) {
            // expected
    ...
    public void testCalcPlacementsFloatArrayArrayNullArray()
        throws Exception {
        try {
            this.aggregator.calcPlacements((double[][]) null);
            fail("IllegalArgumentException should be thrown.");
        } catch (IllegalArgumentException e) {
            // expected
        }
    ...
    public void testCalcPlacementsFloatArrayArrayNullScoresEntries()
        throws Exception {
        try {
            this.aggregator.calcPlacements(new double[][] {new double[] {95.0f}, null});
            fail("IllegalArgumentException should be thrown.");
        } catch (IllegalArgumentException e) {
            // expected
        }
    ...
    public void testCalcPlacementsFloatArrayArrayNegativeScoresEntries()
        throws Exception {
        try {
            this.aggregator.calcPlacements(new double[][] {new double[] {95.0f}, new double[] {-0.5f}});
            fail("IllegalArgumentException should be thrown.");
        } catch (IllegalArgumentException e) {
            // expected
        }
    ...
    public void testCalcPlacementsAggregatedSubmissionArrayInconsistentEntries()
        ...
        try {
            this.aggregator.calcPlacements(new AggregatedSubmission[] {
                new AggregatedSubmission(1L, new double[] {95.5f}, 95.5f),
                new AggregatedSubmission(2L, new double[] {95.0f, 96.0f}, 95.5f),
            });
            fail("InconsistentDataException should be thrown.");
        } catch (InconsistentDataException e) {
            // expected
