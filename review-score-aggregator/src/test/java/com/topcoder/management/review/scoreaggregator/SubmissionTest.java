...
public class SubmissionTest extends TestCase {
    ...
    public void testSubmission_Accuracy() {
        Submission sub = new Submission(1, new double[] {0.0f, 90.0f});
    ...
    public void testSubmission_NegativeId() {
        try {
            new Submission(-1, new double[] {0.0f, 90.0f});
    ...
    public void testSubmission_ZeroId() {
        try {
            new Submission(0, new double[] {0.0f, 90.0f});
            fail("IllegalArgumentException is expected.");
        } catch (IllegalArgumentException iae) {
            // Success
        }
    ...
    public void testSubmission_ScoresWithInvalidElement_1() {
        try {
            new Submission(1, new double[] {0.0f, Float.NaN});
            fail("IllegalArgumentException is expected.");
        } catch (IllegalArgumentException iae) {
            // Success
        }
    ...
    public void testSubmission_ScoresWithInvalidElement_2() {
        try {
            new Submission(1, new double[] {0.0f, Float.POSITIVE_INFINITY});
            fail("IllegalArgumentException is expected.");
        } catch (IllegalArgumentException iae) {
            // Success
        }
    ...
    public void testSubmission_ScoresWithInvalidElement_3() {
        try {
            new Submission(1, new double[] {0.0f, Float.NEGATIVE_INFINITY});
            fail("IllegalArgumentException is expected.");
        } catch (IllegalArgumentException iae) {
            // Success
        }
