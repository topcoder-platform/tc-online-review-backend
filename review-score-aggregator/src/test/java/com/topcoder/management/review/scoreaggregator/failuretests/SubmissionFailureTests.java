...
public class SubmissionFailureTests extends TestCase {
    ...
    public void testSubmissionNegativeId() {
        try {
            new Submission(-1L, new double[] {90.5f, 88.5f, 95.5f});
    ...
    public void testSubmissionZeroId() {
        try {
            new Submission(0L, new double[] {90.5f, 88.5f, 95.5f});
            fail("IllegalArgumentException should be thrown.");
        } catch (IllegalArgumentException e) {
            // expected
        }
    ...
    public void testSubmissionNegativeScores() {
        try {
            new Submission(1L, new double[] {90.5f, -1.5f, 95.5f});
            fail("IllegalArgumentException should be thrown.");
        } catch (IllegalArgumentException e) {
            // expected
        }
    ...
    public void testSubmissionZeroScores() {
        new Submission(1L, new double[] {90.5f, 0.0f, 95.5f});
    }
    ...
    public void testSubmissionNaNScores() {
        try {
            new Submission(1L, new double[] {90.5f, Float.NaN, 95.5f});
            fail("IllegalArgumentException should be thrown.");
        } catch (IllegalArgumentException e) {
            // expected
        }
    ...
    public void testSubmissionPositiveInfScores() {
        try {
            new Submission(1L, new double[] {90.5f, Float.POSITIVE_INFINITY, 95.5f});
            fail("IllegalArgumentException should be thrown.");
        } catch (IllegalArgumentException e) {
            // expected
        }
    ...
    public void testSubmissionNegativeInfScores() {
        try {
            new Submission(1L, new double[] {90.5f, Float.NEGATIVE_INFINITY, 95.5f});
            fail("IllegalArgumentException should be thrown.");
        } catch (IllegalArgumentException e) {
            // expected
        }
