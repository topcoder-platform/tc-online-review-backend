...
public class StandardTieBreakerTest extends TestCase {
    ...
    public void testBreakTies_Accuracy_1() throws Exception {
        AggregatedSubmission sub1 = new AggregatedSubmission(1, new double[] {10.0f, 90.0f}, 50.0f);
        AggregatedSubmission sub2 = new AggregatedSubmission(2, new double[] {11.0f, 89.0f}, 50.0f);
    ...
    public void testBreakTies_Accuracy_2() throws Exception {
        AggregatedSubmission sub1 = new AggregatedSubmission(1, new double[] {10.0f, 90.0f, 40.0f}, 50.0f);
        AggregatedSubmission sub2 = new AggregatedSubmission(2, new double[] {11.0f, 89.0f, 20.0f}, 50.0f);
        AggregatedSubmission sub3 = new AggregatedSubmission(3, new double[] {12.0f, 79.0f, 21.0f}, 50.0f);
    ...
    public void testBreakTies_Accuracy_3() throws Exception {
        AggregatedSubmission sub1 = new AggregatedSubmission(1, new double[] {15.0f, 95.0f, 14.0f}, 50.0f);
        AggregatedSubmission sub2 = new AggregatedSubmission(2, new double[] {11.0f, 89.0f, 20.0f}, 50.0f);
        AggregatedSubmission sub3 = new AggregatedSubmission(3, new double[] {12.0f, 79.0f, 21.0f}, 50.0f);
        int[] expected = new int[] {1, 3, 2};
        int[] received = breaker.breakTies(new AggregatedSubmission[] {sub1, sub2, sub3});
    ...
    public void testBreakTies_Accuracy_4() throws Exception {
        AggregatedSubmission sub1 = new AggregatedSubmission(1, new double[] {15.0f, 95.0f, 14.0f}, 50.0f);
        AggregatedSubmission sub2 = new AggregatedSubmission(2, new double[] {11.0f, 99.0f, 20.0f}, 50.0f);
        AggregatedSubmission sub3 = new AggregatedSubmission(3, new double[] {12.0f, 79.0f, 21.0f}, 50.0f);
    ...
    public void testBreakTies_Accuracy_5() throws Exception {
        AggregatedSubmission sub1 = new AggregatedSubmission(1, new double[] {15.0f, 95.0f, 14.0f}, 50.0f);
        AggregatedSubmission sub2 = new AggregatedSubmission(2, new double[] {15.0f, 95.0f, 14.0f}, 50.0f);
        AggregatedSubmission sub3 = new AggregatedSubmission(3, new double[] {15.0f, 95.0f, 14.0f}, 50.0f);
        int[] expected = new int[] {1, 1, 1};
        int[] received = breaker.breakTies(new AggregatedSubmission[] {sub1, sub2, sub3});
        assertEquals("Received array not match expected one.", expected.length, received.length);
        for (int i = 0; i < expected.length; ++i) {
    ...
    public void testBreakTies_Accuracy_6() throws Exception {
        AggregatedSubmission sub1 = new AggregatedSubmission(1, new double[] {15.0f, 96.0f, 14.0f}, 50.0f);
        AggregatedSubmission sub2 = new AggregatedSubmission(2, new double[] {15.0f, 95.0f, 13.0f}, 50.0f);
        AggregatedSubmission sub3 = new AggregatedSubmission(3, new double[] {15.0f, 95.0f, 14.0f}, 50.0f);
        int[] expected = new int[] {1, 3, 2};
        int[] received = breaker.breakTies(new AggregatedSubmission[] {sub1, sub2, sub3});
        assertEquals("Received array not match expected one.", expected.length, received.length);
    ...
    public void testBreakTies_Accuracy_7() throws Exception {
        AggregatedSubmission sub1 = new AggregatedSubmission(1, new double[] {15.0f, 96.0f, 14.0f}, 50.0f);
        AggregatedSubmission sub2 = new AggregatedSubmission(2, new double[] {15.0f, 95.0f, 15.0f}, 50.0f);
        AggregatedSubmission sub3 = new AggregatedSubmission(3, new double[] {14.0f, 93.0f, 12.0f}, 50.0f);
    ...
    public void testBreakTies_Accuracy_8() throws Exception {
        AggregatedSubmission sub1 = new AggregatedSubmission(1, new double[] {15.0f, 92.0f, 14.0f}, 50.0f);
        AggregatedSubmission sub2 = new AggregatedSubmission(2, new double[] {15.0f, 95.0f, 11.0f}, 50.0f);
        AggregatedSubmission sub3 = new AggregatedSubmission(3, new double[] {14.0f, 95.0f, 14.0f}, 50.0f);
        int[] expected = new int[] {1, 1, 1};
        int[] received = breaker.breakTies(new AggregatedSubmission[] {sub1, sub2, sub3});
        assertEquals("Received array not match expected one.", expected.length, received.length);
        for (int i = 0; i < expected.length; ++i) {
    ...
    public void testBreakTies_InconsistentArray() throws Exception {
        try {
            AggregatedSubmission sub1 = new AggregatedSubmission(1, new double[] {10.0f, 90.0f}, 50.0f);
            AggregatedSubmission sub2 = new AggregatedSubmission(2, new double[] {10.0f}, 10.0f);
