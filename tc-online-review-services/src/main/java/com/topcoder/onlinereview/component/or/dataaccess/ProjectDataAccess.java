...
public class ProjectDataAccess {
  ...
  public List<CockpitProject> getAllCockpitProjects() {
    Map<String, List<Map<String, Object>>> results =
        baseDataAccess.runQuery("cockpit_projects", (String) null, (String) null);
  ...
  public List<CockpitProject> getCockpitProjectsForUser(long userId) {
    Map<String, List<Map<String, Object>>> results =
        baseDataAccess.runQuery("direct_my_projects", "uid", String.valueOf(userId));
  ...
  public List<ClientProject> getAllClientProjects() {
    Map<String, List<Map<String, Object>>> results =
        baseDataAccess.runQuery("client_projects", (String) null, (String) null);
    List<Map<String, Object>> projectsResultContainer =
        results.getOrDefault("client_projects", newArrayList());
  ...
  public List<ClientProject> getClientProjectsForUser(long userId) {
    Map<String, List<Map<String, Object>>> results =
        baseDataAccess.runQuery("client_projects_by_user", "uid", String.valueOf(userId));
  ...
  private Project[] searchProjectsByQueryTool(
    ...
    Map<String, List<Map<String, Object>>> results =
        baseDataAccess.runQuery(projectQuery, paramName, paramValue);
    ...
    for (int i = 0; i < projectsData.size(); i++) {
      Map<String, Object> row = projectsData.get(i);
    ...
    List<Map<String, Object>> projectInfoData = results.get(projectInfoQuery);
    for (Map<String, Object> row : projectInfoData) {
      long projectId = getLong(row, "project_id");
