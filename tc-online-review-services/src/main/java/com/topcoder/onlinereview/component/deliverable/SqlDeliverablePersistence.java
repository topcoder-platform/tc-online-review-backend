...
public class SqlDeliverablePersistence {
  ...
  private Deliverable[] loadDeliverablesWithoutSubmission(String matchCondition)
    ...
    List<Map<String, Object>> rows = executeSql(jdbcTemplate, LOAD_DELIVERABLES_WITHOUT_SUBMISSION_SQL + matchCondition);
  ...
  private Deliverable[] loadDeliverablesWithSubmission(String matchCondition)
    ...
    // load deliverables
    List<Map<String, Object>> rows = executeSql(jdbcTemplate, LOAD_DELIVERABLES_WITH_SUBMISSION_SQL + matchCondition);
