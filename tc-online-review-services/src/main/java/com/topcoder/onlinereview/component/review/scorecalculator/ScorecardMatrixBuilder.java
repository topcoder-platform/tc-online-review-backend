 ...
 * @version     1.0.4
 */
public class ScorecardMatrixBuilder {
    ...
    public ScorecardMatrix buildScorecardMatrix(Scorecard scorecard) throws ScorecardStructureException {
        ...
        for (int groupIndex = 0; groupIndex < groups.length; ++groupIndex) {
            ...
            final com.topcoder.onlinereview.component.scorecard.Section[] sections = group.getAllSections();
            final double totalSectionsWeight = sumWeights(sections, scorecard, groupIndex, -1);

            for (int sectionIndex = 0; sectionIndex < sections.length; ++sectionIndex) {
                final com.topcoder.onlinereview.component.scorecard.Section section = sections[sectionIndex];
                if (section.getWeight() == 0.0) {
                    continue;
                }
                final Section sectionSection =
     ...
     */
    private static Section createSection(WeightedScorecardStructure structure,
