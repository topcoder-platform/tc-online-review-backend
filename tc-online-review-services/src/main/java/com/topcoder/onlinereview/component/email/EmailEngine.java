...
public class EmailEngine {
     ...
     */
    static final String PROPERTIES_FORMAT = ".xml";
    /**
     ...
     */
    public static void send(TCSEmailMessage message) throws SendingException {
    ...
    protected static void send(Address from, Address[] to, Address[] cc, Address[] bcc, String subject, String data,
        String contentType, Map attachments, Map headers) throws SendingException {
        checkNull(from, "from");
        checkNull(to, "to");
        ...
        try {
            ...
            log.error("Failed to get attachment", e);
