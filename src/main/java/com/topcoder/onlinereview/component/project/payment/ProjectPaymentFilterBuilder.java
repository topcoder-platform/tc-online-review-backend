...
/**
 * This is a static helper class that provides factory methods for creating filters that can be used
 * when searching for project payments
 *
...
public final class ProjectPaymentFilterBuilder {
   ...
   *
   * @param projectPaymentTypeId the project payment type id
   * @return the filter, non null
   */
   ...
   *
   * @param transferred the PACTs payment id
   * @return the filter, non null
   */
