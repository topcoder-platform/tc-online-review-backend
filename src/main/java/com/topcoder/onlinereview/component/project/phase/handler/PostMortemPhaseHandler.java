...
public class PostMortemPhaseHandler extends AbstractPhaseHandler {
     ...
     * @since 1.4
     */
    private static final Logger log = LoggerFactory.getLogger(PostMortemPhaseHandler.class.getName());
     ...
     */
    public PostMortemPhaseHandler(ManagerHelper managerHelper,
                    ...
                    if (valid) {
                        ...
                        if (!alreadyPostMortemReviewer) {
                            ...
                            if (!hasPendingTerms) {
                                ...
                                log.warn("Can not assign Post-Mortem Reviewer role to user "
