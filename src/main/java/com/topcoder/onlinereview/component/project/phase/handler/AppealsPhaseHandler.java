...
public class AppealsPhaseHandler extends AbstractPhaseHandler {
     ...
     * @since 1.1
     */
    private static final Logger log = LoggerFactory.getLogger(AppealsPhaseHandler.class.getName());
     ...
     */
    public AppealsPhaseHandler(ManagerHelper managerHelper,
            ...
            if (!result.isSuccess()) {
                ...
                try {
                    ...
                    log.error(new LogMessage(phase.getId(), null,
                            "Fail to check if appeals can be closed early.").toString(), phe);
                    throw phe;
                }
