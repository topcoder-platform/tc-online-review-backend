...
public class SpecificationSubmissionPhaseHandler extends AbstractPhaseHandler {
     ...
     * changed after that.
     */
    private static final Logger log = LoggerFactory.getLogger(SpecificationSubmissionPhaseHandler.class.getName());
     ...
     */
    public SpecificationSubmissionPhaseHandler(ManagerHelper managerHelper,
