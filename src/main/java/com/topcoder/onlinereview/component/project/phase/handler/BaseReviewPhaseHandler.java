...
abstract class BaseReviewPhaseHandler extends AbstractPhaseHandler {
     ...
     */
    public BaseReviewPhaseHandler(ManagerHelper managerHelper,
        ...
        this.minPeerReviews = minPeerReviews;

        // get the template for REST API URL to aggregate peer review scores for challenge
        this.peerReviewAggregationURLTemplate = peerReviewAggregationURLTemplate;
