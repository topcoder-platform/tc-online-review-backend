...
import com.topcoder.onlinereview.component.reviewupload.ConfigurationException;
...
public class FinalReviewPhaseHandler extends AbstractPhaseHandler {
    ...
    */
    ...
    private final String approvalPhaseDuration;

    private final String approvalPhaseDefaultReviewerNumber;
    private final String approvalPhaseDefaultScorecardID;
     ...
     */
    public FinalReviewPhaseHandler(ManagerHelper managerHelper,
        ...
        this.finalFixDuration = finalFixDuration;
        this.studioFinalFixDuration = studioFinalFixDuration;
        this.approvalPhaseDuration = approvalPhaseDuration;
        this.approvalPhaseDefaultReviewerNumber = approvalPhaseDefaultReviewerNumber;
        this.approvalPhaseDefaultScorecardID = approvalPhaseDefaultScorecardID;
    }
    ...
    private boolean checkFinalReview(Phase phase, String operator) throws PhaseHandlingException {
        try {
            ...
            if (rejected) {
                ...
                com.topcoder.onlinereview.component.project.phase.Project currentPrj = phase.getProject();
     ...
     * @since 1.3
     */
    void insertApprovalPhase(com.topcoder.onlinereview.component.project.phase.Project currentPrj, Phase currentPhase,
        ...
        try {
            ...
            String approvalPhaseDefaultReviewerNumberT;
            String approvalPhaseDefaultScorecardIDT;

            if (lastApprovalPhase == null) {
                approvalPhaseDefaultReviewerNumberT = approvalPhaseDefaultReviewerNumber;

                approvalPhaseDefaultScorecardIDT = approvalPhaseDefaultScorecardID;
            } else {
                approvalPhaseDefaultReviewerNumberT = (String) lastApprovalPhase.getAttribute(Constants.PHASE_CRITERIA_REVIEWER_NUMBER);
                approvalPhaseDefaultScorecardIDT = (String) lastApprovalPhase.getAttribute(Constants.PHASE_CRITERIA_SCORECARD_ID);
            }

            Phase approvalPhase = PhasesHelper.getApprovalPhase(currentPrj);
            approvalPhase.setAttribute(Constants.PHASE_CRITERIA_REVIEWER_NUMBER, approvalPhaseDefaultReviewerNumberT);
            approvalPhase.setAttribute(Constants.PHASE_CRITERIA_SCORECARD_ID, approvalPhaseDefaultScorecardIDT);
