...
public class PhaseTemplate {
     ...
     */
    @Autowired
    private XmlPhaseTemplatePersistence persistence;
    ...
    public Project applyTemplate(String templateName, Date startDate) throws PhaseTemplateException {
        ...
        Project project = new Project(startDate, workdaysFactory.createWorkdaysInstance());
    ...
    public Project applyTemplate(String templateName) throws PhaseTemplateException {
        ...
        return this.applyTemplate(templateName, new Date());
    }
     ...
     */
    public void setPersistence(XmlPhaseTemplatePersistence persistence) {
    ...
    public Workdays getWorkdays() {
        ...
        return workdaysFactory.createWorkdaysInstance();
    }
    ...
    public Project applyTemplate(String templateName, long[] leftOutPhaseIds) throws PhaseTemplateException {
        ...
        return this.applyTemplate(templateName, leftOutPhaseIds, new Date());
    }
