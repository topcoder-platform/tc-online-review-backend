...
import com.topcoder.onlinereview.component.resource.ResourceRoleFilterBuilder;
...
public final class PhasesHelper {
     ...
     * @since 1.1
     */
    public static final String PAYMENT_PROPERTY_KEY = "Payment";

    /**
     * This constant stores Payment Status property key.
     * @since 1.4
     */
    public static final String PAYMENT_STATUS_PROPERTY_KEY = "Payment Status";
     ...
     * @since 1.7.2
     */
    public static final String MAXIMUM_SUBMISSIONS = "Maximum Submissions";
     ...
     */
    public static void checkValuesMap(Map<String, Object> map) {
     ...
     */
    public static void checkPhaseType(Phase phase, String type) throws PhaseNotSupportedException {
     ...
     */
    public static boolean checkPhaseStatus(PhaseStatus phaseStatus) throws PhaseHandlingException {
     ...
     */
    public static boolean isPhaseToStart(PhaseStatus status) {
     ...
     */
    public static boolean isPhaseToEnd(PhaseStatus status) {
     ...
     */
    public static OperationCheckResult checkPhaseDependenciesMet(Phase phase, boolean bPhaseStarting) {
     ...
     */
    public static boolean reachedPhaseEndTime(Phase phase) {
     ...
     *         providing a reasoning message (not null)
     */
    public static OperationCheckResult checkPhaseCanStart(Phase phase) {
     ...
     */
    public static Phase locatePhase(Phase phase, String phaseType, boolean forward, boolean required)
        throws PhaseHandlingException {
     ...
     */
    public static Review[] searchReviewsForPhase(ManagerHelper managerHelper, long phaseId, Long submissionId)
            throws PhaseHandlingException {
            try {
     ...
     *             if there was an error during retrieval.
     */
    public static Review[] searchReviewsForResources(ManagerHelper managerHelper,
     ...
     */
    public static Resource[] searchResourcesForRoleNames(ManagerHelper managerHelper,
     ...
     * @since 1.3
     */
    public static Resource[] searchProjectResourcesForRoleNames(ManagerHelper managerHelper,
     ...
     */
    public static float getScorecardMinimumScore(ScorecardManager scorecardManager, Review review)
        throws PhaseHandlingException {
     ...
     */
    public static int getIntegerAttribute(Phase phase, String attrName) throws PhaseHandlingException {
     ...
     *             if an error occurs during retrieval.
     */
    public static Submission[] getPhaseSubmissions(UploadManager uploadManager,
     ...
     *             if an error occurs during retrieval.
     */
    public static Submission[] getProjectSubmissions(UploadManager uploadManager,
     ...
     *             if an error occurs during retrieval.
     */
    public static Submission[] getActiveProjectSubmissions(UploadManager uploadManager,
     ...
     *             submission exist.
     */
    public static Submission getEarliestActiveSubmission(UploadManager uploadManager, long projectId) throws PhaseHandlingException {
     ...
     */
    public static Review getWorksheet(ManagerHelper managerHelper, long phaseId)
        throws PhaseHandlingException {
     ...
     */
    public static Resource getWinningSubmitter(ManagerHelper managerHelper, long projectId)
        throws PhaseHandlingException {
        try {
            ResourceManager resourceManager = managerHelper.getResourceManager();
            ProjectManager projectManager = managerHelper.getProjectManager();
            com.topcoder.onlinereview.component.project.management.Project project = projectManager.getProject(projectId);
     ...
     * @since 1.1
     */
    public static void insertPostMortemPhase(Project currentPrj, Phase currentPhase,
        ...
        try {
            com.topcoder.onlinereview.component.project.management.Project project = projectManager.getProject(currentPrj.getId());
     ...
     * @since 1.1
     */
    public static int insertFinalFixAndFinalReview(Phase currentPhase, PhaseManager phaseManager,
     ...
     * @since 1.4
     */
    public static boolean isFirstPhase(Phase phase) {
        // Get all phases for the project
        Phase[] phases = phase.getProject().getAllPhases();
     ...
     */
    public static int createNewPhases(Project currentPrj, Phase currentPhase, PhaseType[] newPhaseTypes, Long[] newPhaseLengths,
     ...
     */
    public static long copyReviewerResource(Resource oldResource, ManagerHelper managerHelper,
     ...
     */
    public static void copyComments(Review fromWorkSheet, Review toWorkSheet, String[] typesToCopy,
     ...
     *            types of comments to copy.
     */
    public static void copyReviewItems(Review fromWorkSheet, Review toWorkSheet, String[] typesToCopy) {
     ...
     *            destination worksheet.
     */
    public static void copyFinalReviewItems(Review fromWorkSheet, Review toWorkSheet) {
        Item[] reviewItems = fromWorkSheet.getAllItems();
     ...
     */
    public static Review cloneReview(Review review) {
     ...
     *             if any error occurs
     */
    public static List<Map<String, Object>> getSubmitterValueArray(ManagerHelper helper,
     ...
     * @since 1.2
     */
    public static List<Map<String, Object>> constructSubmitterValues(Submission[] submissions,
     ...
     * @since 1.1
     */
    public static boolean canCloseAppealsEarly(ManagerHelper managerHelper, long projectId) throws PhaseHandlingException {
        try {
            ResourceManager resourceManager = managerHelper.getResourceManager();
     ...
     * @since 1.3
     */
    public static boolean areParentProjectsCompleted(long projectId, ManagerHelper managerHelper) {
        ...
        for (ProjectLink link : links) {
            if (!link.getType().isAllowOverlap()) {
                com.topcoder.onlinereview.component.project.management.Project parentProject = link.getDestProject();
     ...
     * @since 1.3
     */
    public static Phase getPostMortemPhase(com.topcoder.onlinereview.component.project.phase.Project project) {
     ...
     * @since 1.3
     */
    public static Phase getApprovalPhase(Project project) {
     ...
     * @since 1.7.6
     */
    public static Phase getReviewPhase(Project project) {
     ...
     * @since 1.4
     */
    public static Submission getSpecificationSubmission(Phase phase, ManagerHelper managerHelper,
                                                 Logger log) throws PhaseHandlingException {
        ...
        if (submissions.length > 1) {
            log.error("Multiple specification submissions exist.");
     ...
     * @since 1.4
     */
    public static boolean areParentProjectsCompleted(Phase phase,
        ManagerHelper managerHelper, Logger log) throws PhaseHandlingException {
        try {
            return PhasesHelper.areParentProjectsCompleted(phase.getProject().getId(), managerHelper);
        } catch (PersistenceException e) {
            log.error(new LogMessage(phase.getId(), null,
                "PersistenceException when checking parent projects completed.", e).toString());
            throw new PhaseHandlingException("PersistenceException when checking parent projects completed.", e);
        } catch (PhaseManagementException e) {
            log.error(new LogMessage(phase.getId(), null, "Fail to check parent projects completed.", e).toString());
     ...
     */
    public static RankedSubmission breakTies(RankedSubmission submission, Submission[] submissions,
     ...
     */
    public static Submission getSubmissionById(Submission[] submissions, long submissionId) throws PhaseHandlingException {
        for (Submission sub : submissions) {
     ...
     * @since 1.7.1
     */
    public static void setSubmissionPrize(com.topcoder.onlinereview.component.project.management.Project project, Submission[] subs,
     ...
     */
    public static boolean isStudio(com.topcoder.onlinereview.component.project.management.Project project) {
     ...
     */
    static boolean isPeerReview(com.topcoder.onlinereview.component.project.management.Project project) {
     ...
     */
    public static boolean isPeerReview(ManagerHelper helper, Phase phase) throws PhaseHandlingException {
        try {
            com.topcoder.onlinereview.component.project.management.Project project =
     ...
     * @throws PhaseHandlingException if any error occurred
     */
    public static void autoScreenStudioSubmissions(com.topcoder.onlinereview.component.project.management.Project project, ManagerHelper helper,
