...
import com.topcoder.onlinereview.component.distribution.commands.CommandExecutionCondition;
import com.topcoder.onlinereview.component.distribution.commands.ConvertToPDFCommand;
import com.topcoder.onlinereview.component.distribution.commands.CopyFileCommand;
import com.topcoder.onlinereview.component.distribution.commands.CopyFileTemplateCommand;
import com.topcoder.onlinereview.component.distribution.commands.CreateFolderCommand;
import com.topcoder.onlinereview.component.distribution.commands.DefineVariableCommand;
import com.topcoder.onlinereview.component.distribution.commands.ExecuteProcessCommand;
import com.topcoder.onlinereview.component.distribution.commands.UndefineVariableCommand;
import com.topcoder.onlinereview.component.distribution.conditions.VariableDefinedCondition;
import com.topcoder.onlinereview.component.distribution.conditions.VariableNotDefinedCondition;
 ...
 * @version 1.0
 */
public class DistributionScriptParser {
    /**
     * <p>
     * Creates an instance of DistributionScriptParserImpl.
     * </p>
     */
    public DistributionScriptParser() {
    }
     ...
     */
    public void parseCommands(InputStream stream, DistributionScript script) throws DistributionScriptParsingException {
        ...
        try {
            while ((line = reader.readLine()) != null) {
                ...
                List<CommandExecutionCondition> conditions = new ArrayList<>();
