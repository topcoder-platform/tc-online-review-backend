...
import com.topcoder.onlinereview.component.distribution.PDFConversionException;
...
public class ConvertToPDFCommand extends BaseDistributionScriptCommand {
     ...
     */
    public ConvertToPDFCommand(List<CommandExecutionCondition> conditions, String sourcePath,
            String destPath) {
        super(conditions);
    ...
    protected void executeCommand(DistributionScriptExecutionContext context)
        ...
        Util.logInfo(log, "Converting file <" + curSourcePath + "> to <"
                + curDestPath + ">.");
