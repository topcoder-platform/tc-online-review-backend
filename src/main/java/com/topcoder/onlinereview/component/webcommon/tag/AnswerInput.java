...
import com.topcoder.onlinereview.component.webcommon.model.Answer;
import com.topcoder.onlinereview.component.webcommon.model.Question;
...
public class AnswerInput extends BaseTag {
    protected static Logger log = LoggerFactory.getLogger(AnswerInput.class);
