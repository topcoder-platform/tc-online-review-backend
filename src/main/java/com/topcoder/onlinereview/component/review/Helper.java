...
final class Helper {
   ...
   *
   * @param jdbcTemplate the connection to perform the query on
  ...
  static <T> T doSingleValueQuery(
    ...
    try {
      ...
      List<Map<String, Object>> resultSet =
          executeSqlWithParam(jdbcTemplate, queryString, newArrayList(queryArgs));
   ...
   * @throws ReviewPersistenceException if the query fails
   */
  static int doDMLQuery(JdbcTemplate jdbcTemplate, String queryString, Object[] queryArgs)
      throws ReviewPersistenceException {
    Helper.assertStringNotNullNorEmpty(queryString, "queryString");
   ...
   * @param jdbcTemplate the db entityManager
   * @param tableName the table name
   * @param columnName the column name
   * @return the number of deleted entities
   */
  static int deleteEntities(String tableName, String columnName, long id, JdbcTemplate jdbcTemplate)
      throws ReviewPersistenceException {
  ...
  static int deleteEntities(
      String tableName, String columnName, Collection<Long> ids, JdbcTemplate jdbcTemplate)
      throws ReviewPersistenceException {
    if (ids.isEmpty()) {
      return 0;
    }
    ...
    return Helper.doDMLQuery(jdbcTemplate, query, ids.toArray());
  }
   ...
   */
  static long countEntities(String tableName, String columnName, long id, JdbcTemplate jdbcTemplate)
      throws ReviewPersistenceException {
    return getLong(
        executeSql(
                jdbcTemplate,
