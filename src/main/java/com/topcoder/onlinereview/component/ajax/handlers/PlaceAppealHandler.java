 ...
 */
package com.topcoder.onlinereview.component.ajax.handlers;

import com.topcoder.onlinereview.component.ajax.AjaxRequest;
import com.topcoder.onlinereview.component.ajax.AjaxResponse;
import com.topcoder.onlinereview.component.ajax.AjaxSupportHelper;
import com.topcoder.onlinereview.component.ajax.ConfigurationException;
...
public class PlaceAppealHandler extends ReviewCommonHandler {
	private static final Logger log = LoggerFactory.getLogger(PlaceAppealHandler.class.getName());
