...
import com.topcoder.onlinereview.component.ajax.AjaxRequestHandler;
...
public abstract class CommonHandler implements AjaxRequestHandler {
     ...
     * The logger.
     */
    private static final Logger logger = LoggerFactory.getLogger(CommonHandler.class.getName());
    ...
    protected CommonHandler() throws ConfigurationException {
        try {
            ...
            resourceManager = getBean(ResourceManager.class);

            logger.debug("create ResourceManager from objectfactory with its class type.");
