 ...
 */
package com.topcoder.onlinereview.component.document.xslttemplate;

import com.topcoder.onlinereview.component.document.Template;
import com.topcoder.onlinereview.component.document.TemplateData;
...
import com.topcoder.onlinereview.component.document.Util;
...
public class XsltTemplate implements Template {
    ...
    private NodeList getNodeListCopy(NodeList nodeList, boolean readOnly) {
        ...
        com.topcoder.onlinereview.component.document.fieldconfig.Node[] nodes = nodeList.getNodes();
