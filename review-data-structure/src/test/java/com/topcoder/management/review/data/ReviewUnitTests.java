...
public class ReviewUnitTests extends TestCase {
     ...
     */
    private Double score = new Double("20.06");
    ...
    public void testSetScoreWithInfinityScore() {
        try {
            review.setScore(new Double(Double.POSITIVE_INFINITY));
            fail("IllegalArgumentException should be thrown");
        } catch (IllegalArgumentException e) {
            // success
        }
    ...
    public void testSetScoreWithNaNScore() {
        try {
            review.setScore(new Double(Double.NaN));
            fail("IllegalArgumentException should be thrown");
        } catch (IllegalArgumentException e) {
            // success
        }
