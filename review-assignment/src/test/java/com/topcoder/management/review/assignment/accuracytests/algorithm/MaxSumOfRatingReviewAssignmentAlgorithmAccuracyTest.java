...
public class MaxSumOfRatingReviewAssignmentAlgorithmAccuracyTest {
    ...
    public void testMeasureQuality() throws Exception {
        ...
        double actualQuality = ((MaxSumOfRatingReviewAssignmentAlgorithmSubclass) this.testedInstance).measureQuality(assignment.keySet());
    ...
    private static class MaxSumOfRatingReviewAssignmentAlgorithmSubclass 
         ...
         */
        @Override
        protected double measureQuality(Set<ReviewApplication> assignment)
