...
public class SubmissionTests extends TestCase {
    ...
    public void testSetUploads_Accuracy1() {
        submission.setUpload(uploads.get(0));
        assertEquals("uploads is not set properly.", uploads.get(0), submission.getUpload());
    }
    ...
    public void testGetUploads_Accuracy1() {
        submission.setUpload(uploads.get(0));
        assertEquals("getUploads doesn't work properly.", uploads.get(0), submission.getUpload());
    }
    ...
    public void testIsValidToPersist_Accuracy7() {
        submission.setUpload(new Upload());
        submission.setSubmissionStatus(submissionStatus);
        submission.setSubmissionType(submissionType);
        submission.setId(1);
