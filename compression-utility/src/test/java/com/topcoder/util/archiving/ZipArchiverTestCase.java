...
public class ZipArchiverTestCase extends AbstractArchiverTestCase {
    ...
    public void testCreateNameFromFileNull() throws Exception {
        try {
            ZipCreator.createNameFromFile(null, true);
    ...
    public void testCreateNameFromFileAccuracy() throws Exception {
        // Test relative path
        assertEquals(ZipCreator.createNameFromFile(new File("test_files", "dir1"), true), "test_files/dir1");

        // Test empty path
        assertEquals(ZipCreator.createNameFromFile(new File(""), true), "");
    }
