...
public interface ProjectPaymentPersistence {
     ...
     * @throws IllegalArgumentException                       if projectPayment is null or if operator is null or empty string
     ...
     * @throws IllegalStateException                          if persistence was not configured properly
     */
    ProjectPayment create(ProjectPayment projectPayment, String operator) throws ProjectPaymentValidationException,
     ...
     * @throws IllegalStateException                          if persistence was not configured properly
     */
    void update(ProjectPayment projectPayment, String operator) throws ProjectPaymentValidationException,
     ...
     * @throws IllegalStateException                        if persistence was not configured properly
     */
    ProjectPayment retrieve(long projectPaymentId) throws ProjectPaymentManagementPersistenceException;
     ...
     * @throws IllegalStateException                        if persistence was not configured properly
     */
    boolean delete(long projectPaymentId) throws ProjectPaymentManagementPersistenceException;

    /**
     * Configures the instance with use of the given configuration object.
     *
     * @param configuration the configuration object
     * @throws IllegalArgumentException                       if configuration is null (is not thrown by implementations that don't use any configuration
     *                                                        parameters)
     ...
     */
    void configure(ConfigurationObject configuration);
}
