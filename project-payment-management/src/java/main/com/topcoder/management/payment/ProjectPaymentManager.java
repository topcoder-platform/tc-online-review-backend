...
public interface ProjectPaymentManager {
     ...
     */
    ProjectPayment create(ProjectPayment projectPayment, String operator) throws ProjectPaymentManagementException;
     ...
     *             if some other error occurred when accessing the persistence for example.
     */
    void update(ProjectPayment projectPayment, String operator) throws ProjectPaymentManagementException;
     ...
     */
    ProjectPayment retrieve(long projectPaymentId) throws ProjectPaymentManagementException;
     ...
     *             if some error occurred when accessing the persistence for example.
     */
    boolean delete(long projectPaymentId) throws ProjectPaymentManagementException;
     ...
     */
    List<ProjectPayment> search(Filter filter) throws ProjectPaymentManagementException;
}
