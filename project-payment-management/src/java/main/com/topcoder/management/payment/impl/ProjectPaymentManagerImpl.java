...
public class ProjectPaymentManagerImpl implements ProjectPaymentManager {
     ...
     *
     * @throws ProjectPaymentManagementConfigurationException if error occurred while reading the configuration or initializing this class
     */
     ...
     * @throws IllegalArgumentException                       if filePath or namespace is null/empty
     * @throws ProjectPaymentManagementConfigurationException if error occurred while reading the configuration or initializing this class
     */
     ...
     *
     * @param configuration the configuration object for this class
     ...
     * @throws ProjectPaymentValidationException              if projectPayment's id is not null, projectPayment's type is null, projectPayment's resourceId is
     ...
     * @throws ProjectPaymentManagementPersistenceException   if some other error occurred when accessing the persistence for example.
     */
     ...
     * @param operator       ID of the user doing the operation
     * @throws IllegalArgumentException                       if projectPayment is null or if operator is null or empty string
     * @throws ProjectPaymentValidationException              if projectPayment's id is null or negative, projectPayment's resourceId is null, projectPayment's
     ...
     * @throws ProjectPaymentManagementPersistenceException if some error occurred when accessing the persistence for example.
     */
    ...
    private List<ProjectPayment> getProjectPayments(CustomResultSet resultSet)
        ...
        List<ProjectPayment> result = new ArrayList<>();
        try {
