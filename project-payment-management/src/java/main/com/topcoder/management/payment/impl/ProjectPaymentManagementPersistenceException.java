...
/**
 * <p>
 * This exception is thrown by implementations of persistence interfaces when error occurs while accessing the
 * persistence.
 * </p>
 *
 * <p>
...
public class ProjectPaymentManagementPersistenceException extends ProjectPaymentManagementException {
     ...
     * </p>
     *
     * @param message the explanation of the error. Can be empty string or <code>null</code> (useless, but allowed).
     */
     ...
     *
     * @param message the explanation of the error. Can be empty string or <code>null</code> (useless, but allowed).
     * @param cause   the underlying cause of the error. Can be <code>null</code>, which means that initial exception
