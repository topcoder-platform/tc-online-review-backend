...
public class GroupPersistence {
  ...
  public Group getGroup(long id) throws PersistenceException {
    ...
    try {
      ...
      var rs = executeSqlWithParam(entityManager, SELECT_SCORECARD_GROUP_BY_ID, newArrayList(id));
  ...
  Group[] getGroups(long parentId) throws PersistenceException {
    try {
      ...
      var rs =
          executeSqlWithParam(
              entityManager, SELECT_SCORECARD_GROUP_BY_PARENT_ID, newArrayList(parentId));
