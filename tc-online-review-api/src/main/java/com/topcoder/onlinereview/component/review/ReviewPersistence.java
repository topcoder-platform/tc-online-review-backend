...
public class ReviewPersistence {
  ...
  public void createReview(Review review, String operator) throws ReviewPersistenceException {
    ...
    try {
      ...
      if (review.getId() > 0) {
        if (Helper.countEntities(REVIEW_TABLE, "review_id", review.getId(), entityManager) != 0) {
          log.error(
              new LogMessage(
                      review.getId(),
                      operator,
  ...
  private void createReview(Review review, String operator, Map<Object, Long> changeTable)
    ...
    Helper.doDMLQuery(entityManager, CREATE_REVIEW_SQL, queryArgs);
  ...
  private void createReviewComments(
    ...
    try {
      ...
      for (int i = 0; i < comments.length; ++i) {
        ...
        Helper.doDMLQuery(entityManager, CREATE_REVIEW_COMMENT_SQL, queryArgs);
      }
    } catch (IDGenerationException e) {
  ...
  private void createReviewItems(
    ...
    try {
      ...
      for (int i = 0; i < items.length; ++i) {
        ...
        Helper.doDMLQuery(entityManager, CREATE_REVIEW_ITEM_SQL, queryArgs);
  ...
  private void createReviewItemComments(
    ...
    try {
      ...
      for (int i = 0; i < comments.length; ++i) {
        ...
        Helper.doDMLQuery(entityManager, CREATE_REVIEW_ITEM_COMMENT_SQL, queryArgs);
      }
    } catch (IDGenerationException e) {
  ...
  private void updateReview(Review review, String operator, Map<Object, Long> changeTable)
    ...
    Helper.doDMLQuery(entityManager, UPDATE_REVIEW_SQL, queryArgs);
  ...
  private void updateReviewComment(Comment comment, Long index, String operator)
    ...
    Helper.doDMLQuery(entityManager, UPDATE_REVIEW_COMMENT_SQL, queryArgs);
  }
  ...
  private void updateReviewItem(
    ...
    Helper.doDMLQuery(entityManager, UPDATE_REVIEW_ITEM_SQL, queryArgs);
  ...
  private void updateReviewItemComment(Comment comment, Long index, String operator)
    ...
    Helper.doDMLQuery(entityManager, UPDATE_REVIEW_ITEM_COMMENT_SQL, queryArgs);
  }
  ...
  private Set<Long> getReviewCommentIDs(Long reviewId) {
    var result =
        executeSqlWithParam(entityManager, QUERY_REVIEW_COMMENT_IDS_SQL, newArrayList(reviewId));
  ...
  private Set<Long> getReviewItemIDs(Long reviewId) throws ReviewPersistenceException {
    var result =
        executeSqlWithParam(entityManager, QUERY_REVIEW_ITEM_IDS_SQL, newArrayList(reviewId));
    // build the set from result list
  ...
  private Set<Long> getReviewItemCommentIDs(Long itemId) {
    ...
    var result =
        executeSqlWithParam(entityManager, QUERY_REVIEW_ITEM_COMMENT_IDS_SQL, newArrayList(itemId));
    // build the set from result list
  ...
  private void deleteReviewComments(Set<Long> reviewCommentIDs) throws ReviewPersistenceException {
    ...
    Helper.deleteEntities(
        REVIEW_COMMENT_TABLE, "review_comment_id", reviewCommentIDs, entityManager);
  }
  ...
  private void deleteReviewItems(Set<Long> reviewItemIDs) throws ReviewPersistenceException {
    ...
    Helper.deleteEntities(
        REVIEW_ITEM_COMMENT_TABLE, "review_item_id", reviewItemIDs, entityManager);
    log.debug("delete entries from " + REVIEW_ITEM_TABLE + " with the review item ids: " + ids);
    Helper.deleteEntities(REVIEW_ITEM_TABLE, "review_item_id", reviewItemIDs, entityManager);
    // delete item uploads
    if (!reviewItemUploadIDs.isEmpty()) {
      ...
      Helper.deleteEntities(UPLOAD_TABLE, "upload_id", reviewItemUploadIDs, entityManager);
    }
  }
  ...
  private void deleteReviewItemComments(Set<Long> reviewItemCommentIDs)
    ...
    Helper.deleteEntities(
        REVIEW_ITEM_COMMENT_TABLE, "review_item_comment_id", reviewItemCommentIDs, entityManager);
  }
  ...
  public Review getReview(long id) throws ReviewPersistenceException {
    ...
    try {
      // check whether the review id is already in the database
      if (Helper.countEntities(REVIEW_TABLE, "review_id", id, entityManager) == 0) {
        log.error(
  ...
  public Review[] searchReviews(Filter filter, boolean complete) throws ReviewPersistenceException {
    ...
    try {
      ...
      var resultSet = (List<Map<String, Object>>) searchBundle.search(filter);
      if (resultSet.isEmpty()) {
        return new Review[0];
      }
      for (var map : resultSet) {
  ...
  private Review[] getReviews(String idList) {
    ...
    var result =
        executeSql(
            entityManager, QUERY_REVIEWS_SQL.replaceFirst(ID_ARRAY_PARAMETER_REGULAR_EXP, idList));
  ...
  public CommentType[] getAllCommentTypes() {
    ...
    if (cachedCommentTypes == null) {
      var result = executeSql(entityManager, QUERY_ALL_COMMENT_TYPES_SQL);
  ...
  public void addReviewComment(long reviewId, Comment comment, String operator)
    ...
    try {
      ...
      if (Helper.countEntities(REVIEW_TABLE, "review_id", reviewId, entityManager) == 0) {
        log.error(
            new LogMessage(
                    reviewId,
                    operator,
      ...
      Long index = Helper.countEntities(REVIEW_COMMENT_TABLE, "review_id", reviewId, entityManager);
      // create the comment
      createReviewComments(
  ...
  public void addItemComment(long itemId, Comment comment, String operator)
    ...
    try {
      ...
      if (Helper.countEntities(REVIEW_ITEM_TABLE, "review_item_id", itemId, entityManager) == 0) {
        log.error(
            new LogMessage(
                    itemId,
                    operator,
      ...
      Long index =
          Helper.countEntities(REVIEW_ITEM_COMMENT_TABLE, "review_item_id", itemId, entityManager);
      // create the comment
      createReviewItemComments(
  ...
  public void removeReview(long id, String operator) throws ReviewPersistenceException {
    ...
    try {
      ...
      Helper.deleteEntities(REVIEW_COMMENT_TABLE, "review_id", id, entityManager);
      // Delete the review record:
      int deletedNum = Helper.deleteEntities(REVIEW_TABLE, "review_id", id, entityManager);
      if (deletedNum == 0) {
        throw new ReviewEntityNotFoundException(
