...
public final class Comparators {
    ...
    public static class ProjectPhaseComparer extends PhaseDateComparator {
        ...
        final private static String[] phaseOrder = new String[] {
            ORConstants.SPECIFICATION_SUBMISSION_PHASE_NAME, ORConstants.SPECIFICATION_REVIEW_PHASE_NAME,
            ORConstants.REGISTRATION_PHASE_NAME, ORConstants.CHECKPOINT_SUBMISSION_PHASE_NAME, 
            ORConstants.CHECKPOINT_SCREENING_PHASE_NAME, ORConstants.CHECKPOINT_REVIEW_PHASE_NAME, 
            ORConstants.SUBMISSION_PHASE_NAME, ORConstants.ITERATIVE_REVIEW_PHASE_NAME, ORConstants.SCREENING_PHASE_NAME,
            ORConstants.REVIEW_PHASE_NAME, ORConstants.APPEALS_PHASE_NAME, ORConstants.APPEALS_RESPONSE_PHASE_NAME,
            ORConstants.AGGREGATION_PHASE_NAME, ORConstants.AGGREGATION_REVIEW_PHASE_NAME, ORConstants.FINAL_FIX_PHASE_NAME,
            ORConstants.FINAL_REVIEW_PHASE_NAME, ORConstants.APPROVAL_PHASE_NAME
        };
        ...
        public int compare(Object o1, Object o2) {
            ...
            boolean isPhase1IterativeReview = phase1.getPhaseType().getName()
                    .equalsIgnoreCase(ORConstants.ITERATIVE_REVIEW_PHASE_NAME);
    ...
    public static class SubmissionComparer implements Comparator<Submission> {
        ...
        public void assignSubmitters(Resource[] submitters) {
            ...
            for (Resource submitter : submitters) {
                ...
                if (!submitter.getResourceRole().getName().equalsIgnoreCase(ORConstants.SUBMITTER_ROLE_NAME)) {
