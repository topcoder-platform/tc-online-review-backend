...
public class UploadManager {
     ...
     */
    public UploadManager(UploadPersistence persistence, SearchBundle uploadSearchBundle,
     ...
     */
    public UploadManager(UploadPersistence persistence, SearchBundleManager searchBundleManager)
        throws IDGenerationException {
