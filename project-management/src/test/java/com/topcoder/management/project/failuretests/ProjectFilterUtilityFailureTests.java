...
public class ProjectFilterUtilityFailureTests extends TestCase {
    ...
    /**
     * Test the method <code>buildProjectPropertyNameInFilter(List)</code> with null names.
     * IllegalArgumentException should be thrown.
     */
    public void testbuildProjectPropertyNameInFilterWithNullNames() {
        try {
    ...
    /**
     * Test the method <code>buildProjectPropertyNameInFilter(List)</code> with empty names.
     * IllegalArgumentException should be thrown.
     */
    public void testbuildProjectPropertyNameInFilterWithEmptyNames() {
        try {
    ...
    /**
     * Test the method <code>buildProjectPropertyNameInFilter(List)</code> with invalid names which contains
    ...
    /**
     * Test the method <code>buildProjectPropertyValueInFilter(List)</code> with null values.
     * IllegalArgumentException should be thrown.
     */
    public void testbuildProjectPropertyValueInFilterWithNullValues() {
        try {
    ...
    /**
     * Test the method <code>buildProjectPropertyValueInFilter(List)</code> with invalid values which contains
     * element with non-String type. IllegalArgumentException should be thrown.
     */
    public void testbuildProjectPropertyValueInFilterWithNonStringValue() {
        try {
